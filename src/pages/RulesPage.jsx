  ...
  return (
    <div className="panel">
      ...
      <section>
        ...
        <ol>
          <li>Every row must contain the digits 1–9 exactly once.</li>
          <li>Every column must contain the digits 1–9 exactly once.</li>
          <li>Each 3×3 subgrid must also contain the digits 1–9 exactly once.</li>
